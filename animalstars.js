...
function displayAnimal(animal) {
  ...
  clone.querySelector("[data-field=star]").addEventListener("click", (event) => {
    console.log("click");
    // using flag to shw opposite directions choose white or orange star
    // ! this sign means opposite or not equal
    animal.isStarFlag = !animal.isStarFlag;
    let starText;
    if (animal.isStarFlag) {
      starText = "⭐";
    } else {
      starText = "☆";
    }
